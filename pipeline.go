...
var (
	...
	SEPERATION_THRESHOLD    float64     = 0.3 // colors greater in distance than this are turned black
...
func (p *Pipeline) run(img image.Image) {
	...
	i = p.add(accentColorDiffereenceGreyscale(i, SEPERATION_TARGETCOLOR3))
